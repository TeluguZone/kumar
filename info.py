...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5454695536 1918601237').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/collection_Cinemas')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/new_movies_988')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/kalai_support/15')
